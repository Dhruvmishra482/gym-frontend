...
<Link
  to="/pricing"
  className="inline-block border-2 border-orange-400 text-orange-400 px-8 py-3 rounded-full font-bold hover:bg-orange-400 hover:text-black transition-all text-center"
>
  View Pricing
</Link>
          </div>
