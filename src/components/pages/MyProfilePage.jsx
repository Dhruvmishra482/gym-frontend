...
import { getOwnerProfile, updateOwnerProfile, validateProfileData } from "../services/memberService"
...
const MyProfile = () => {
  ...
  const getFullName = () => {
    ...
    return `${profile.firstName || ''} ${profile.lastName || ''}`.trim() || 'No name set';
  };

  // Get profile completion percentage
  const getProfileCompletion = () => {
    if (!profile) return 0;
    const fields = [profile.firstName, profile.lastName, profile.mobileNumber, profile.email];
