      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-800 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
            ...
            <p className="text-gray-300 animate-pulse">Loading your royal profile...</p>
          </div>
        </div>
                  ...
                  <div>
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div className="flex space-x-1">
                        {[...Array(3)].map((_, i) => (
                          <Star key={i} className="h-4 w-4 text-yellow-400 fill-current animate-pulse" style={{animationDelay: `${i * 200}ms`}} />
                        ))}
                      </div>
                    </div>
                    <p className="text-gray-300 text-lg mb-2">👑 Gym Overlord</p>
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-yellow-400 font-medium">Level 99 Admin</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-300">Royal Profile Status</span>
                  </div>
                  ...
                  <div className="w-full bg-gray-800 rounded-full h-3 overflow-hidden">
                    <div 
                      className={`h-3 rounded-full transition-all duration-1000 ease-out bg-gradient-to-r ${
                        profileCompletion === 100 ? 'from-green-400 to-emerald-500' : 
                        profileCompletion >= 75 ? 'from-blue-400 to-purple-500' : 
                        profileCompletion >= 50 ? 'from-yellow-400 to-orange-500' : 'from-red-400 to-rose-500'
                      }`}
              ...
              <div className="group">
                ...
                {isEditing ? (
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-black/30 backdrop-blur-sm border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-400 ${
                        errors.firstName ? 'border-red-500 bg-red-500/10' : 'border-white/20 hover:border-white/30'
                      }`}
                  ...
                  <div className="flex items-center space-x-3 py-3 px-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                    ...
                    <span className="text-gray-200 font-medium">{profile?.firstName || 'Not set'}</span>
                  </div>
                )}
              </div>
                ...
                {isEditing ? (
                  <div className="relative">
                    <input
                      ...
                      onChange={onInputChange}
                      className={`w-full px-4 py-3 bg-black/30 backdrop-blur-sm border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-400 ${
                        errors.lastName ? 'border-red-500 bg-red-500/10' : 'border-white/20 hover:border-white/30'
                      }`}
                  ...
                  <div className="flex items-center space-x-3 py-3 px-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                    <User className="h-5 w-5 text-purple-400" />
                    <span className="text-gray-200 font-medium">{profile?.lastName || 'Not set'}</span>
                  </div>
                )}
              </div>
              ...
              <div className="group">
                ...
                {isEditing ? (
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-black/30 backdrop-blur-sm border rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-400 ${
                        errors.mobileNumber ? 'border-red-500 bg-red-500/10' : 'border-white/20 hover:border-white/30'
                      }`}
                  ...
                  <div className="flex items-center space-x-3 py-3 px-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                    ...
                    <span className="text-gray-200 font-medium">{profile?.mobileNumber || 'Not set'}</span>
                  </div>
                )}
              </div>
              ...
              <div className="group">
                ...
                {isEditing ? (
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-black/30 backdrop-blur-sm border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-400 ${
                        errors.email ? 'border-red-500 bg-red-500/10' : 'border-white/20 hover:border-white/30'
                      }`}
                  ...
                  <div className="flex items-center space-x-3 py-3 px-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:bg-white/10 transition-all duration-300">
                    ...
                    <span className="text-gray-200 font-medium">{profile?.email || 'Not set'}</span>
                  </div>
                )}
              </div>
            </div>
            ...
            {isEditing && (
              <div className="flex items-center justify-between pt-8 border-t border-white/10 mt-8">
                <div className="flex space-x-4">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <Save className={`h-5 w-5 ${isSaving ? 'animate-spin' : 'group-hover:animate-pulse'}`} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="flex items-center space-x-3 py-3 px-4 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-sm rounded-xl border border-yellow-500/30">
                    ...
                    <span className="text-yellow-200 font-bold capitalize">{profile.accountType || 'Owner'}</span>
