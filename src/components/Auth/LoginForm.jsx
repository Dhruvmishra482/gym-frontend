  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-red-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,rgba(255,215,0,0.2),transparent_50%)] animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-0 left-0 w-full h-full bg-[radial-gradient(circle_at_40%_90%,rgba(255,69,0,0.2),transparent_50%)] animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-20 right-20 opacity-30 animate-pulse" style={{animationDelay: '1.5s'}}>
          <Shield className="w-14 h-14 text-yellow-500" />
        </div>
        <div className="absolute bottom-20 left-20 opacity-25 animate-spin" style={{animationDuration: '8s'}}>
          <Zap className="w-12 h-12 text-orange-500" />
        </div>
        <div className="absolute bottom-32 right-32 opacity-30 animate-bounce" style={{animationDelay: '2.5s'}}>
          <Crown className="w-10 h-10 text-yellow-400" />
        </div>
        <div className="absolute top-1/2 left-8 opacity-20 animate-pulse" style={{animationDelay: '3s'}}>
          <Flame className="w-8 h-8 text-red-600" />
        </div>
        <div className="absolute top-1/3 right-8 opacity-25 animate-bounce" style={{animationDelay: '4s'}}>
      ...
      <div className={`relative z-10 w-full max-w-md transform transition-all duration-1000 ${
        ...
        <div className="bg-black/90 backdrop-blur-xl border-2 border-red-500/40 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-red-400/60 transition-all duration-500">
          ...
          <div className={`text-center mb-8 transform transition-all duration-700 delay-300 ${
            isLoaded ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'
          }`}>
            <div className="relative inline-flex items-center justify-center w-20 h-20 mb-4 group">
              <div className="absolute inset-0 bg-gradient-to-r from-red-600 via-red-500 to-yellow-500 rounded-full shadow-lg animate-spin" style={{animationDuration: '3s'}}></div>
            ...
            <div className="flex items-center justify-center space-x-2 mb-2">
              ...
              <Flame className="w-4 h-4 text-orange-500 animate-bounce" style={{animationDelay: '0.5s'}} />
            </div>
          ...
          <div className={`space-y-6 transform transition-all duration-700 delay-500 ${
            ...
            <div className="relative group">
              ...
              <div className="relative">
                <div className={`absolute inset-0 bg-gradient-to-r from-red-500/30 to-yellow-500/30 rounded-xl blur-sm transition-opacity duration-300 ${
                  focusedField === 'email' ? 'opacity-100' : 'opacity-0'
                }`}></div>
                <User className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 z-10 transition-all duration-300 ${
                  focusedField === 'email' ? 'text-yellow-400 scale-110' : 'text-red-500'
                }`} />
                <input
                  type="email"
                  name="email"
            ...
            <div className="relative group">
              ...
              <div className="relative">
                ...
                <Lock className={`absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 z-10 transition-all duration-300 ${
                  focusedField === 'password' ? 'text-yellow-400 scale-110' : 'text-red-500'
                }`} />
                <input
          ...
          {/* Enhanced Footer */}
          <div className={`mt-8 text-center transform transition-all duration-700 delay-700 ${
