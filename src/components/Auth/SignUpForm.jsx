    ...
    <div className="min-h-screen relative overflow-hidden py-24">
        ...
        <div
          ...
          style={{
            ...
            animation: `floatParticle ${
              particle.speed + 4
            }s ease-in-out infinite ${particle.delay}s alternate`,
          }}
        ></div>
      ))}
      ...
      {flames.map((flame) => (
        <div
          ...
          style={{
            ...
            background: "linear-gradient(0deg, #ef4444, #fbbf24, transparent)",
            borderRadius: "50% 50% 50% 50% / 60% 60% 40% 40%",
            animation: `flicker ${2 + flame.delay}s ease-in-out infinite ${
              flame.delay
            }s`,
          }}
        ></div>
      ...
      <div
        ...
        style={{
          ...
          height: "400px",
          background:
            "radial-gradient(circle, rgba(239, 68, 68, 0.15) 0%, rgba(251, 191, 36, 0.1) 30%, transparent 70%)",
          borderRadius: "50%",
        }}
      ></div>
        ...
        <div
          ...
          style={{
            transform: `perspective(1200px) rotateX(${
              ...
              (mousePosition.x -
                (typeof window !== "undefined" ? window.innerWidth : 500) / 2) /
              50
            }deg) translateZ(20px)`,
            transformStyle: "preserve-3d",
          }}
                ...
                {Object.keys(formData).map((field, index) => (
                  <div key={field} className="relative group">
                    ...
                    {field === "confirmPassword" && formData[field] && (
                      <div
                        className={`absolute -top-3 left-12 px-3 py-1 text-white text-sm font-bold rounded-full transform scale-90 animate-bounce ${
                          formData.password === formData.confirmPassword
                    ...
                    {field === "confirmPassword" && formData[field] && (
                      <div
                        className={`text-sm mt-2 ml-14 transition-all duration-300 ${
                          formData.password === formData.confirmPassword
                            ? "text-green-400"
                            : "text-red-400"
                        }`}
